...
from keras.layers import Input, GRU, Cropping2D, Cropping1D, Permute, Maximum, Dropout, Activation
...
def convolutional_model(input_shape=(NUM_FRAMES,NUM_Freq, 1), batch_size=BATCH_SIZE * TRIPLET_PER_BATCH , num_frames=NUM_FRAMES):
...
def convolutional_model_simple(input_shape=(NUM_FRAMES,NUM_Freq, 1), batch_size=BATCH_SIZE * TRIPLET_PER_BATCH , num_frames=NUM_FRAMES):
